...
def get_settings(workspace_root: str | Path | None = None) -> Settings:
    ...
    return Settings(
        ...
        worker_backend=os.getenv("ALVIS_WORKER_BACKEND", "sdk"),
        worker_model=os.getenv("ALVIS_WORKER_MODEL", "gpt-5.4"),
        ...
        openai_api_key=os.getenv("ALVIS_OPENAI_API_KEY") or os.getenv("OPENAI_API_KEY"),
